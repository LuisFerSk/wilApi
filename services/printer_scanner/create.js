...
async function create(printer_scanner, transaction = undefined) {
    ...
    if (!printer_scanner.license_plate) throw new Error('Falta la placa del equipo.')
    ...
    if (!printer_scanner.phone) throw new Error('Falta el numero de teléfono de usuario del equipo.')
